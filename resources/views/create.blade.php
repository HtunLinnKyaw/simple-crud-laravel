...
@section('content')
    ...
    <div class="justify-center flex mt-10">
        <h1 class="text-center text-2xl text-white ">Create Product Form</h1>
        ...
        <form class="mt-5" method="post">
            ...
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                <div class="">
                    ...
                    <input type="text" name="color" id="last_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Color"  />
                </div>
                <div class="">
                    <label for="" class="block mb-2 text-white text-sm font-medium  dark:text-white">Category</label>
                    <input type="text" name="category" id="company" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Category"  />
                </div>
                <div class="">
                    <label for="" class="block mb-2 text-white text-sm font-medium  dark:text-white">Price</label>
                    <input type="number" name="price" id="phone" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Price" pattern=""  />
                </div>
